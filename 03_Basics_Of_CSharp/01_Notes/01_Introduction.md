...
This code is human-readable but the computer cannot understand it directly.

Therefore it must be compiled.
...
The compiler does NOT create machine code directly.

Instead, it creates IL.
...
Think of IL as a universal language.

### Analogy

Imagine a company with employees from:

* India
* Japan
* Germany

Instead of learning everyone's language, everyone communicates using English.

Similarly:

* Different .NET languages compile to IL
* CLR understands IL

This makes all .NET languages work together.
...
CLR uses JIT to convert IL into machine code.
...
Machine code is the language understood by the CPU.

Only after this step can the application execute.
...
## 10. Architecture Including Libraries
...
JIT generates optimized machine code.

<br>

### Reusability

Developers use existing .NET libraries.

<br>

### Security

CLR performs security checks.

<br>

### Memory Management

CLR handles garbage collection automatically.

<br>

## 14. Real-World Example

Suppose you build an Employee Management System.
...
### What are the main components of .NET Architecture?
...
### What provides ready-made functionality?

.NET Class Library

### Why is .NET cross-platform?

Because IL is platform-independent and CLR/JIT generate machine code specific to the operating system.
